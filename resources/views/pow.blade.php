    ...
    <div class="price-box">
        ...
        <form class="form-horizontal form-pricing" role="form">
            ...
            <div class="price-slider">
                ...
                <span>step : 0.0001 | min : -15 | max : 15</span>
                <div class="col-sm-12">
                    <div id="slider"></div>
                </div>
            </div>
            ...
            <div class="price-form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="number" class="form-controller" id="amount-label" step="0.0001" onchange="update1()"  min="-15" max="15">
                    </div>
                </div>
                <hr>
                <div class="form-group">
                ...
                <div class="form-group total">
                    ...
                    <span class="help-text">(number ^ power)</span>
                    <div class="col-sm-6">
